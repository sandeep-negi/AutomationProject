...
import qa.custom.api.model.pojo.teacherprofile.TeacherProfile;
...
public class TeacherDashboardApi {
 ...
 //   private static final Logger logger = (Logger) LogManager.getLogger(TeacherDashboardApi.class);
    ...
    public Response visitTeacherDashboard(String sessionId){
        ...
        Response response = given().cookie("_session_id", sessionId).
                ...
                log().all().
                when().
                get(EndPoint.TEACHER_DASHBOARD.url).
                then().
                log().all().
                extract().
                response();
...
//    }
    ...
    public static String getGradeId(String grade){
        ...
        switch (grade) {
            ...
            default :
                Assert.fail("Invalid Grade " + gradeCode);
        }
        return gradeCode;
    }
    ...
    public Response addNewKlass(Map<String, String> data, String sessionId){
        ...
        Response response = given().cookie("_session_id", sessionId).
                ...
                log().all().
                when().
                post(EndPoint.ADD_NEW_KLASS.url).
                then().
                log().all().
                extract().
                response();
