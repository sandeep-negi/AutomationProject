...
import qa.context.APIContext;
import qa.context.APITokens;
import qa.custom.api.endpoints.APIGateway;
import qa.custom.api.endpoints.TeacherEndPoint;
import qa.custom.api.model.request.teachersignin.TeacherSignin;
import qa.custom.api.model.request.teachersignin.User;
import qa.custom.api.model.response.StudentResponse;
import qa.custom.api.model.response.userworksheet.SavedWorksheets;
import qa.custom.dto.TeacherSignupDTO;
import qa.custom.entity.model.Klass;
import qa.custom.entity.model.Student;
import qa.custom.entity.model.Task;
...
import static qa.constants.SplashLearnConstants.*;
import static qa.custom.api.RestAssuredHelper.*;
...
public class TeacherAPI {
    ...
    public void signup(TeacherSignupDTO teacherSignup) {
