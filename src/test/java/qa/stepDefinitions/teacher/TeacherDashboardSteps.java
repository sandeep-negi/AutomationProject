...
import qa.custom.api.operations.GetAssignedPersona;
import qa.custom.api.operations.LoginApi;
import qa.custom.api.operations.TeacherDashboardApi;
import qa.pages.*;
import qa.stepDefinitions.LocalStorage;
import qa.utils.DataGeneratorUtility;
import qa.utils.TeacherUtility;

import java.time.Instant;
import java.time.temporal.ChronoUnit;
import java.util.*;

import static qa.selenium.SeleniumActions.open;
...
//    private final Evaluator evaluator = new Evaluator();
    ...
    public void user_should_login_successfully_to_his_dashboard() {
        teacherDashboardPage.loadUrl(EndPoint.TEACHER_DASHBOARD.url);
    ...
    public void user_adds_new_class_using_api() throws JsonProcessingException {
        ...
        teacherData.getTeacherKlassStudentData("username","pasword");
    ...
    public void verifyParentConnectedCountWhenStudentIsLinked() {
        ...
        String generatedParentEmail = DataGeneratorUtility.parentEmail();
