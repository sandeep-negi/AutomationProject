...
import qa.custom.ImageComparisonUtility;
import qa.custom.api.endpoints.TeacherEndPoint;
import qa.custom.api.model.pojo.EmailVerificationIntent;
import qa.dao.UserOtpDAO;
import qa.pages.*;
...
import static qa.constants.SplashLearnConstants.DEFAULT_TIMEOUT;
import static qa.selenium.SeleniumActions.sleep;
...
//    private final Evaluator evaluator = new Evaluator();
    ...
    public void the_user_is_on_login_page() {
        // Using Enum we are getting endPoint
        loginPage.loadUrl(EndPoint.SIGN_IN_PAGE.url);
    ...
    public void verifyErrorMessageWhenUserEntersAlreadyVerifiedOTP(String statusType) {
      //  String userEmail = evaluator.evaluate(context.getData(), context.getData().get("username"));
        String codeStatus = getOtp("abc@gmail.com", statusType);
